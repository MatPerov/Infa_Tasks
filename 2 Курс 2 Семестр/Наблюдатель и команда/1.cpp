...
class MySquare : public Observer, public Drawable
{
protected:
    sf::RectangleShape mShape;
    sf::RenderWindow& mRenderWindow;
...
public:
    MySquare(sf::RenderWindow& window, sf::Vector2f position, float size)
        : mRenderWindow(window)
    {
        mShape.setPosition(position);
        mShape.setFillColor(sf::Color::Green);
...
int main()
{
    ...
    sf::RenderWindow window(sf::VideoMode(1000, 800), "Multiple Observers", sf::Style::Default, settings);
    ...
    std::vector<Observer*> observers
    {
        ...
        new MySquare{window,{900, 400},50 }
    };
